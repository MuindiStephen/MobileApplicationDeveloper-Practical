...
class GeneralAssessmentFragment : Fragment() {
    ...
    private var selectedOnDiet = "Yes"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSave.setOnClickListener {
            if (validatedInputs()) {
                viewModel.addANewGeneralAssessmentInfoRemotely(
                ...
                try {
                    ...
                    viewModel.addANewGeneralAssessmentInfoLocally(
                    ...
                    displaySnackBar("General Assessment visit created locally")
                } catch (e: Exception) {
                    Timber.tag("Add Gen visit").e(
                        "=>failed." +
                                "ERROR==${e.message}"
                    )
                }
    ...
    private fun subScribeAddGeneralAssessmentRemotelyStateObservables() {
        lifecycleScope.launch {
            viewModel.addNewGeneralAssessmentRemoteState.collect { state ->
                when(state) {
                    ...
                    is ResourceNetwork.Success -> {
                        ...
                        if (msg == "Visit Added Successfully") {
                            ...
                            displaySnackBar(msg ?: "Failed to add this assessment")
                        }
                    }
